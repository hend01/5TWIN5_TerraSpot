...
// assets
import avatar from 'assets/images/users/logo.png';
...
const Profile = () => {
  ...
  const handleLogout = async () => {
    localStorage.removeItem('token'); // Remove the token from local storage or delete the cookie
    navigate('/login');
  };
                      ...
                      <Grid container justifyContent="space-between" alignItems="center">
                        <Grid item>
                          <Stack direction="row" spacing={1.25} alignItems="center">
                            <Avatar alt="profile user" src={avatar} sx={{ width: 32, height: 32 }} />
                            <Stack>
                              <Typography variant="h6">INFOplus</Typography>
